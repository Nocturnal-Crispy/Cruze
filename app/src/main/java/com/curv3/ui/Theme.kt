...
private val DarkScheme = darkColorScheme(
    primary = Curv3Colors.Red,
    onPrimary = Color.White,
    primaryContainer = Curv3Colors.RedDeep,
    onPrimaryContainer = Color(0xFFFFDAD6),
    inversePrimary = Curv3Colors.RedBright,

    secondary = Curv3Colors.RedBright,
    onSecondary = Color.White,
    secondaryContainer = Curv3Colors.RedDim,
    onSecondaryContainer = Color(0xFFFFD9D5),

    tertiary = Color(0xFFB8BCC4),
    onTertiary = Curv3Colors.Black,

    background = Curv3Colors.Black,
    onBackground = Curv3Colors.Text,
    surface = Curv3Colors.Black,
    onSurface = Curv3Colors.Text,
    surfaceVariant = Curv3Colors.Card,
    onSurfaceVariant = Curv3Colors.TextDim,
    surfaceContainerLowest = Color(0xFF060607),
    surfaceContainerLow = Curv3Colors.Raised,
    surfaceContainer = Curv3Colors.Raised,
    surfaceContainerHigh = Curv3Colors.Card,
    surfaceContainerHighest = Color(0xFF26272C),

    outline = Curv3Colors.Line,
    outlineVariant = Color(0xFF26272C),

    error = Color(0xFFFF8A80),
    onError = Color(0xFF2A0000),
    errorContainer = Curv3Colors.RedDeep,
...
@Composable
fun Curv3Theme(dark: Boolean = true, content: @Composable () -> Unit) {
    MaterialTheme(
